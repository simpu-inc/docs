...
<AccordionGroup>
    ...
    <Accordion title="Email Marketing" icon="envelope-dot">
       Convert customers at the perfect moment with personalized messages. Boost your revenue by identifying the right customer to target.
    </Accordion>
    <Accordion title="Omni-channel Inbox" icon="inboxes">
        Say goodbye to missed messages. Bring every conversation and interaction—from chat, texts to emails — into a single place, and respond instantly.
    </Accordion>
</AccordionGroup>
